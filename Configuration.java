...
public class Configuration {
    ...
    protected KnowledgeBase sourceInfo = new KnowledgeBase();
    protected KnowledgeBase targetInfo = new KnowledgeBase();
    ...
    public Configuration(KnowledgeBase sourceInfo, KnowledgeBase targetInfo, String metricExpression, String acceptanceRelation,
   ...
   // @Override
    ...
    public KnowledgeBase getSourceInfo() {
        return sourceInfo;
    }

    public KnowledgeBase getTargetInfo() {
        return targetInfo;
    }
    ...
    public void setSourceInfo(KnowledgeBase sourceInfo) {
        this.sourceInfo = sourceInfo;
    }

    public void setTargetInfo(KnowledgeBase targetInfo) {
        this.targetInfo = targetInfo;
    }
