 ...
 */
public class SourceClassTargetMappingMusicWithPagn {
	...
	public static void main(String[] args) throws UnsupportedMLImplementationException {
		...
		String fullClassName = SourceClassTargetMappingMusicWithPagn.class.getName();
		...
		while (classes_sc.hasNext()) 
		{
			...
			while (classes_tc.hasNext()) 
			{
				...
				String Query_Instance_tc = "Select ?instance where {?instance a ?class } Limit 1 ";
